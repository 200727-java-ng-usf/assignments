...
public abstract class Question18AbstractClass {
    public abstract boolean checkForUpperCaseCharacters(String s);
    public abstract String convertAllLowerCaseToUpperCase(String s);
    public abstract void convertToIntegerAddTenThenPrintResult(String s);
}
